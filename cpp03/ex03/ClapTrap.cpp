...
/*   Updated: 2026/01/31 15:23:48 by pde-petr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const int ClapTrap::base_attack_damage = 0;
const int ClapTrap::base_hit_point = 10;
const int ClapTrap::base_energy_points = 10;

ClapTrap::ClapTrap(std::string name) : _name(name), _hit_point(ClapTrap::base_hit_point), _energy_points(ClapTrap::base_energy_points), _attack_damage(ClapTrap::base_attack_damage)
{
